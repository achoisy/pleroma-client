...
const PageContent = () => {
  return (
    <View>
      <Heading type={5}>This is a page PARAMETRE</Heading>
...
class ParametresScreen extends Component {
  componentDidMount() {
    this.props.setActiveDrawerItem(6);
  }
      ...
      <SafeAreaView style={ApplicationStyles.screen.container}>
        <Drawer {...this.props} navToScreen={this._navigation}>
          <View style={ApplicationStyles.body}>
            <Header navAction={this._navAction} title={'Paramètres'} />
            <PageContent />
          </View>
        </Drawer>
      </SafeAreaView>
